  ...
  return (
    <>
      ...
      <SectionWrapper 
        ...
        description="Experience a buttery UI of ProNef
        NFT Marketplace. Smooth constant colors of a
        fluent UI design."
      ...
      <SectionWrapper 
        ...
        description="The app contain two screens.
        The first screen lists all NFTs
        while the second one shows the details
        of a specific NFT."
